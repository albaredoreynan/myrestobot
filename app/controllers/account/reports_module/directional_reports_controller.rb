class Account::ReportsModule::DirectionalReportsController < Account::ReportsModuleController
  include EndMonth

  set_tab :directional_reports
  ...
  def index
    ...
    @settlement_type = SettlementType.all(:conditions => ["is_complimentary != ?", false])
  end
